...
// 왜 'branch' 설명이 짧아졌나: 예전 문구는 "아군 행군용" 이었는데 사실이 아니다 —
//   아군은 PathGraph 를 안 쓰고 AllyWalkGraph 로 걷는다 (2026-09-06 확인, SDD-02 §3-1).
const P3 = '# role: start(보호대상·모체 출발) / exit(탈출) / waypoint(그 외) / branch(도로 밖에 둘 수 있는 유일한 역할)';
