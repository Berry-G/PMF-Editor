...
| 도달 영역 | 마을 (10,13)·(27,9) 둘 다 같은 구역. 도달 가능 `B` 203 (구역 205 = B 203 + V 2), 도달 불가 `B` 178 | 2026-09-03 씨앗으로 계산. 게임 주석 `GreyboxMapData.cs:30-32` 의 215 는 물 10칸 추가 전 값. **2026-09-06 `AllyUnit.CanReach` 와 전수 대조 완료 — 불일치 0** (SDD-04 §7) |
